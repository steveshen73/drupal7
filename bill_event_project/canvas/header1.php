...
?>
<link rel="stylesheet" href="sites/all/themes/clouds/bill_event/css/css.php" type="text/css">
<script>
...
<script src="sites/all/themes/clouds/bill_event/common/dtpicker.js"></script>
<script src="sites/all/themes/clouds/bill_event/common/cpicker.js"></script>
<script src="sites/all/themes/clouds/bill_event/common/toolbox.js"></script>
</head>
...
if ($privs > 0) { //view rights
	...
	echo "<div id='upcoBar'><img class='floatR point' onclick=\"show('upcoBar')\" src=\"sites/all/themes/clouds/bill_event/images/close.png\" alt=\"close\"/><h5 class='dragme'>".$xx['hdr_upco_list']."</h5>\n";
	echo "<div class='sideList'>\n";

	$curD = $_SESSION['cD'];
	$eTime = mktime(0,0,0,substr($curD,5,2),substr($curD,8,2),substr($curD,0,4)) + (($set['lookaheadDays']-1) * 86400); //Unix time of end date
 ...
 //display upcoming events
	...
	echo "<div id='taskBar'><img class='floatR point' onclick=\"show('taskBar')\" src=\"sites/all/themes/clouds/bill_event/images/images/close.png\" alt=\"close\"/><h5 class='dragme'>".$xx['hdr_todo_list']."</h5>\n";
	echo "<div class='sideList'>\n";

	$curD = $_SESSION['cD'];
	$curT = mktime(0,0,0,substr($curD,5,2),substr($curD,8,2),substr($curD,0,4)); //current Unix time
