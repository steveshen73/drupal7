...
//get php tools
require 'sites/all/themes/clouds/bill_event/common/toolbox.php';
...
//run or install
if (!file_exists('sites/all/themes/clouds/bill_event/lcaldbc.dat') and !file_exists('sites/all/themes/clouds/bill_event/config.php')) { header("Location: sites/all/themes/clouds/bill_event/install.php"); exit(); } 
...
$dbPfix = dbConnect();
if ($dbPfix === false) {
	include 'sites/all/themes/clouds/bill_event/config.php'; //no lcaldbc.php; try config.php
}
...
if (!file_exists('sites/all/themes/clouds/bill_event/lang/ui-'.strtolower($_SESSION['cL']).'.php')) { $_SESSION['cL'] = 'English'; }



require 'sites/all/themes/clouds/bill_event/lang/ui-'.strtolower($_SESSION['cL']).'.php';
...
$pages = array (
	 '1' => array ('sites/all/themes/clouds/bill_event/views/year.php','1','0','m','1','0','','y',''),
	 '2' => array ('sites/all/themes/clouds/bill_event/views/month.php','1','0','m','1','0','','y','fm'),
	 '3' => array ('sites/all/themes/clouds/bill_event/views/month.php','1','0','m','1','0','','y','wm'),
	 '4' => array ('sites/all/themes/clouds/bill_event/views/week.php','1','0','m','1','0','','y','fw'),
	 '5' => array ('sites/all/themes/clouds/bill_event/views/week.php','1','0','m','1','0','','y','ww'),
	 '6' => array ('sites/all/themes/clouds/bill_event/views/day.php','1','0','m','1','0','','y',''),
	 '7' => array ('sites/all/themes/clouds/bill_event/views/upcoming.php','1','0','m','1','0',$xx['title_upcoming'],'y',''),
	 '8' => array ('sites/all/themes/clouds/bill_event/views/changes.php','1','0','m','1','0',$xx['title_changes'],'y',''),

	'10' => array ('sites/all/themes/clouds/bill_event/pages/event.php','e','e','e','0','0',$xx['title_event'],'',''),
	'11' => array ('sites/all/themes/clouds/bill_event/pages/eventcheck.php','e','e','e','0','0',$xx['title_check_event'],'',''),

	'20' => array ('sites/all/themes/clouds/bill_event/pages/login.php','e','0','e','0','0',$xx['title_log_in'],'',''),
	'21' => array ('sites/all/themes/clouds/bill_event/pages/search.php','a','0','a','1','0',$xx['title_search'],'y',''),
	'22' => array ('sites/all/themes/clouds/bill_event/lang/ug-'.strtolower($_SESSION['cL']).'.php','h','h','h','0','0',$xx['title_user_guide'],'',''),

	'90' => array ('sites/all/themes/clouds/bill_event/pages/settings.php','a','a','a','1','0',$xx['title_settings'],'',''),
	'91' => array ('sites/all/themes/clouds/bill_event/pages/categories.php','a','a','a','1','0',$xx['title_edit_cats'],'',''),
	'92' => array ('sites/all/themes/clouds/bill_event/pages/users.php','a','a','a','1','0',$xx['title_edit_users'],'',''),
	'93' => array ('sites/all/themes/clouds/bill_event/pages/database.php','a','a','a','1','0',$xx['title_manage_db'],'',''),
	'94' => array ('sites/all/themes/clouds/bill_event/pages/importICS.php','a','a','a','1','0',$xx['title_ics_import'],'',''),
	'95' => array ('sites/all/themes/clouds/bill_event/pages/exportICS.php','a','a','a','1','0',$xx['title_ics_export'],'y',''),
	'96' => array ('sites/all/themes/clouds/bill_event/pages/importCSV.php','a','a','a','1','0',$xx['title_csv_import'],'','')
);
...
if ($pages[$cP][7]) { //retrieve required
	require 'sites/all/themes/clouds/bill_event/common/retrieve.php';
}
//build calendar page
//header
if ($_SESSION['hdr'] == 0) {
...
require 'sites/all/themes/clouds/bill_event/canvas/header'.$hType.'.php';
//page body
if ($privs or $cP == 20) { //access or login
	require 'sites/all/themes/clouds/bill_event/'.$pages[$cP][0];
...
require 'sites/all/themes/clouds/bill_event/canvas/footer'.$fType.'.php';
?>
