...
//initialize
require 'sites/all/themes/clouds/bill_event/views/dw_functions.php';
...
echo '<h4 class="floatC"><a class="noPrint" href="index.php?cD=',$prevDay,'"><img src="sites/all/themes/clouds/bill_event/images/arrowl.png" alt="back"/></a>',$header,'<a class="noPrint" href="index.php?cD=',$nextDay,'"><img src="sites/all/themes/clouds/bill_event/images/arrowr.png" alt="forward"/></a></h4>'."\n";
