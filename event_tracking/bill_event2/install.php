...
//		chmod('./lcaldbc.dat', 0600); //invisible to visitors
		...
		echo "<li>The LuxCal version number and the (encrypted) database credentials have <br>been saved in the file <kbd>lcaldbc.dat</kbd> in the calendar root directory</li>\n";
		echo "</ol>\n";
		echo "<br>";
