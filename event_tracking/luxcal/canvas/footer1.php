...
<?php
echo '<span class="floatR"><a href="http://www.bill.com" target="_blank"><span title="V'.LCV.'">C</span>heck with  <span class="footLB">Bill</span><span class="footLR">.com</span></a></span>'."\n";
