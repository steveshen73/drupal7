...
.// ---- canvas ----
"
header {padding:0px 20px; font:".($topBd ? ' bold' : '').($topIc ? ' italic' : '')." 13px/25px arial,sans-serif;".($topSw ? ' text-shadow: 0.2em 0.3em 0.2em #222;' : '')." text-align:center; background:".BGND1.";}
