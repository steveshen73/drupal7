...
//Relative URL syntax:
var lastrssproxyurl="lastrss/proxy.php"

//Absolute URL syntax. Uncomment below line if you wish to use an absolute reference:
//var lastrssproxyurl="http://"+window.location.hostname+"/lastrss/proxy.php"
...
// -------------------------------------------------------------------
// getAjaxcontent()- Makes asynchronous GET request to "proxy.php" with the supplied parameters
// -------------------------------------------------------------------
...
this.ajaxobj.open('GET', lastrssproxyurl+"?"+parameters, true)
